...
- **Serie wie in Teams:** Im Detailfenster einer wiederkehrenden Aufgabe lässt sich über die Wochentags-Knöpfe festlegen, an welchen Tagen sie gilt – etwa nur montags und mittwochs. Sind alle Tage markiert, gilt sie täglich. Ein im Kalender aufgezogener Termin mit Haken bei *Wiederkehrend* wird automatisch zur wöchentlichen Serie an genau diesem Wochentag.
